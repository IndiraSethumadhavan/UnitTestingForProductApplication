   ...
   public class MongoDbProductManagement
    {
        ...
        public void MongoDbProdManagment()
        {
            ...
            UpdateProduct(new MongoProduct { Name = "Toothbrush", Price = 50.78m, Id = "5ef1e00773a8ca14a86333e8", ProductInStock = 10, ManufacturerDetails = new Manufacturer() { ManufacturerName = "III", PhoneNumber = 762892530, Place = "Hjlmar" } });
            GetAllProducts();
            GetByProductId("5ef1e00773a8ca14a86333da");
        }
        ...
        private void InsertProduct()
        {
            ...
            mongoRep.InsertProduct(new MongoProduct { Name = "CastorOil", Price = 100.33m, ProductInStock = 10, ManufacturerDetails = new Manufacturer() { ManufacturerName = "PVI", PhoneNumber = 762892412, Place = "Qvidingsgatan" } });
            ...
            mongoRep.InsertProduct(new MongoProduct { Name = "sensodyneToothPaste",  Price = 157.23m, ProductInStock = 10, ManufacturerDetails = new Manufacturer() { ManufacturerName = "KHI", PhoneNumber = 762892454, Place = "Hjlmar" } });
            ...
            mongoRep.InsertProduct(new MongoProduct { Name = "Muesli", Price = 222.55m, ProductInStock = 6, ManufacturerDetails = new Manufacturer() { ManufacturerName = "FRT", PhoneNumber = 762892421, Place = "Redbergplasten" } });
            mongoRep.InsertProduct(new MongoProduct { Name = "Pillows", Price = 170.56m, ProductInStock = 5, ManufacturerDetails = new Manufacturer() { ManufacturerName = "SDA", PhoneNumber = 762892411, Place = "Chalmers" } });
            mongoRep.InsertProduct(new MongoProduct { Name = "Curd", Price = 90.33m, ProductInStock = 7, ManufacturerDetails = new Manufacturer() { ManufacturerName = "SER", PhoneNumber = 762892413, Place = "Hjlmar" } });
            mongoRep.InsertProduct(new MongoProduct { Name = "Chicken", Price = 190.22m, ProductInStock = 12, ManufacturerDetails = new Manufacturer() { ManufacturerName = "DFS", PhoneNumber = 762892477, Place = "korsvagen" } });
            mongoRep.InsertProduct(new MongoProduct { Name = "AllPurposeFlour", Price = 279.06m, ProductInStock = 8, ManufacturerDetails = new Manufacturer() { ManufacturerName = "SES", PhoneNumber = 762892454, Place = "Hjlmar" } });
            ...
            mongoRep.InsertProduct(new MongoProduct { Name = "Toys", Price = 89.09m, ProductInStock = 10, ManufacturerDetails = new Manufacturer() { ManufacturerName = "SWE", PhoneNumber = 762892499, Place = "Qvidingsgatan" } });
